...
namespace BigDataOrdersDashboard.ViewComponents.DashboardViewComponents
{
    public class _DashboardMainChartComponentPartial:ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var todayPrepearingSales = _context.Orders
            ...
            var todayShippingSales = _context.Orders
            ...
            ViewBag.todayPrepearingSales = Math.Round(todayPrepearingSales, 2);
            ViewBag.TodayShippingSales = Math.Round(todayShippingSales, 2);
            #endregion
