...
namespace BigDataOrdersDashboard.ViewComponents.DashboardViewComponents
{
    public class _DashboardFirstChartsComponentPartial:ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var preparingCount = _context.Orders.Where(o => o.OrderStatus == "Hazırlanıyor").Count();
            var canceledCount = _context.Orders.Where(o => o.OrderStatus == "İptal Edildi").Count();
            var shippedCount = _context.Orders.Where(o => o.OrderStatus == "Kargoda").Count();
            var completedCount = _context.Orders.Where(o => o.OrderStatus == "Tamamlandı").Count();
