...
namespace BigDataOrdersDashboard.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public IActionResult TextualStatistics()
        {
            ...
            //en çok veğenilen ürün
            var topProduct = _context.Orders
            ...
            .FirstOrDefault(); // Burada tüm nesneyi alıyoruz

            if (topProduct != null)
            {
                ViewBag.TopOrderedProduct = $"{topProduct.ProductName} ({topProduct.TotalQuantity})";
            }

            //en çok beğenilen ürün
            var minProduct = _context.Orders
           .GroupBy(o => o.Product.ProductName)
           .Select(g => new
           {
               ProductName = g.Key,
           ...
           .FirstOrDefault(); // Burada tüm nesneyi alıyoruz
            ...
            if (minProduct != null)
            {
                ViewBag.MinOrderedProduct = $"{minProduct.ProductName} ({minProduct.TotalQuantity})";
            }

            //En çok sipariş gelen ülke
          ...
          .Select(g => new
          {
           ...
           //siparişi en çok tamamlanan ürün
            ...
            //siparişi en çok iade edilen ürün
